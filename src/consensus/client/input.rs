...
impl PyTransactionInput {
    ...
    pub fn get_previous_outpoint_py(&self) -> PyTransactionOutpoint {
        self.0.inner().previous_outpoint.clone().into()
    }

    #[setter]
    #[pyo3(name = "previous_outpoint")]
    pub fn set_previous_outpoint_py(&mut self, outpoint: PyTransactionOutpoint) -> PyResult<()> {
    ...
    #[getter]
    #[pyo3(name = "utxo")]
    pub fn get_utxo_py(&self) -> Option<PyUtxoEntryReference> {
