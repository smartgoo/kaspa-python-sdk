...
class Transaction:
    ...
    def addresses(self, network_type: Union[str, NetworkType]) -> list[Address]: ...
...
def address_from_script_public_key(script_public_key: ScriptPublicKey, network: Union[str, NetworkType]) -> Address: ...
...
class Mnemonic:
    ...
    def __init__(self, phrase: str, language: Optional[Union[str, Language]] = None) -> None: ...    

    @staticmethod
    def validate(phrase: str, language: Optional[Union[str, Language]] = None) -> bool: ...
...
def create_input_signature(tx: Transaction, input_index: int, private_key: PrivateKey, sighash_type: Optional[Union[str, SighashType]] = None) -> str: ...
...
def sompi_to_kaspa_string_with_suffix(sompi: int, network: Union[str, NetworkType]) -> str: ...
...
class Keypair:
    ...
    def to_address(self, network: Union[str, NetworkType]) -> Address: ...

    def to_address_ecdsa(self, network: Union[str, NetworkType]) -> Address: ...
...
class PublicKeyGenerator:
    ...
    def receive_addresses(self, network_type: Union[str, NetworkType], start: int, end: int) -> list[Address]: ...

    def receive_address(self, network_type: Union[str, NetworkType], index: int) -> Address: ...

    def receive_addresses_as_strings(self, network_type: Union[str, NetworkType], start: int, end: int) -> list[str]: ...

    def receive_address_as_string(self, network_type: Union[str, NetworkType], index: int) -> str: ...
    ...
    def change_addresses(self, network_type: Union[str, NetworkType], start: int, end: int) -> list[Address]: ...

    def change_address(self, network_type: Union[str, NetworkType], index: int) -> Address: ...

    def change_addresses_as_strings(self, network_type: Union[str, NetworkType], start: int, end: int) -> list[str]: ...

    def change_address_as_string(self, network_type: Union[str, NetworkType], index: int) -> str: ...
...
class RpcClient:
    ...
    def __init__(self, resolver: Optional[Resolver] = None, url: Optional[str] = None, encoding: Optional[str] = "borsh", network_id: Optional[Union[str, NetworkId]] = "mainnet") -> None: ...
