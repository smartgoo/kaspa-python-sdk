...
class Address:
    ...
    def version_to_string(self) -> builtins.str:
        ...
        """
    @property
    def prefix_to_string(self) -> builtins.str:
        r"""
        ...
        """
    @prefix_from_str.setter
    def prefix_from_str(self, value: builtins.str) -> None:
        r"""
...
class Generator:
    ...
    """
    def __new__(cls, network_id: NetworkId, entries: PyUtxoEntries, change_address: Address, outputs: typing.Optional[PyOutputs] = None, payload: typing.Optional[PyBinary] = None, fee_rate: typing.Optional[builtins.float] = None, priority_fee: typing.Optional[builtins.int] = None, priority_entries: typing.Optional[PyUtxoEntries] = None, sig_op_count: typing.Optional[builtins.int] = None, minimum_signatures: typing.Optional[builtins.int] = None) -> Generator:
        r"""
...
class GeneratorSummary:
    ...
    def network_type(self) -> builtins.str:
        ...
        """
    @property
    def aggregated_utxos(self) -> builtins.int:
        r"""
        ...
        """
    @property
    def aggregate_fees(self) -> builtins.int:
        r"""
        ...
        """
    @property
    def number_of_generated_transactions(self) -> builtins.int:
        r"""
        ...
        """
    @property
    def final_transaction_amount(self) -> typing.Optional[builtins.int]:
        r"""
...
class Mnemonic:
    ...
    def entropy(self, value: builtins.str) -> None:
        ...
        """
    @property
    def phrase_string(self) -> builtins.str:
        r"""
...
class PendingTransaction:
    ...
    def id(self) -> builtins.str:
        ...
        """
    @property
    def payment_value(self) -> typing.Optional[builtins.int]:
        r"""
        ...
        """
    @property
    def change_value(self) -> builtins.int:
        r"""
    ...
    def minimum_signatures(self) -> builtins.int:
        ...
        """
    @property
    def aggregate_input_value(self) -> builtins.int:
        r"""
        ...
        """
    @property
    def aggregate_output_value(self) -> builtins.int:
        r"""
    ...
    def create_input_signature(self, input_index: builtins.int, private_key: PrivateKey, sighash_type: typing.Optional[SighashType] = None) -> builtins.str:
        ...
        """
    def fill_input(self, input_index: builtins.int, signature_script: PyBinary) -> None:
        r"""
...
class RpcClient:
    ...
    def encoding(self) -> builtins.str:
        ...
        """
    @property
    def resolver_node_id(self) -> typing.Optional[builtins.str]:
        r"""
    ...
    def get_block_count(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_block_dag_info(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_coin_supply(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_connected_peer_info(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_info(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_peer_addresses(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_metrics(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_connections(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_sink(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_sink_blue_score(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def ping(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def shutdown(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_server_info(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_sync_status(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_fee_estimate(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_current_network(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def get_system_info(self, request: typing.Optional[dict] = None) -> typing.Any: ...
    def add_peer(self, request: dict) -> typing.Any: ...
    def ban(self, request: dict) -> typing.Any: ...
    def estimate_network_hashes_per_second(self, request: dict) -> typing.Any: ...
    def get_balance_by_address(self, request: dict) -> typing.Any: ...
    def get_balances_by_addresses(self, request: dict) -> typing.Any: ...
    def get_block(self, request: dict) -> typing.Any: ...
    def get_blocks(self, request: dict) -> typing.Any: ...
    def get_block_template(self, request: dict) -> typing.Any: ...
    def get_current_block_color(self, request: dict) -> typing.Any: ...
    def get_daa_score_timestamp_estimate(self, request: dict) -> typing.Any: ...
    def get_fee_estimate_experimental(self, request: dict) -> typing.Any: ...
    def get_headers(self, request: dict) -> typing.Any: ...
    def get_mempool_entries(self, request: dict) -> typing.Any: ...
    def get_mempool_entries_by_addresses(self, request: dict) -> typing.Any: ...
    def get_mempool_entry(self, request: dict) -> typing.Any: ...
    def get_subnetwork(self, request: dict) -> typing.Any: ...
    def get_utxos_by_addresses(self, request: dict) -> typing.Any: ...
    def get_utxo_return_address(self, request: dict) -> typing.Any: ...
    def get_virtual_chain_from_block(self, request: dict) -> typing.Any: ...
    def get_virtual_chain_from_block_v2(self, request: dict) -> typing.Any: ...
    def resolve_finality_conflict(self, request: dict) -> typing.Any: ...
    def submit_block(self, request: dict) -> typing.Any: ...
    def submit_transaction(self, request: dict) -> typing.Any: ...
    def submit_transaction_replacement(self, request: dict) -> typing.Any: ...
    def unban(self, request: dict) -> typing.Any: ...
...
class ScriptBuilder:
    ...
    def __new__(cls) -> ScriptBuilder:
        ...
        """
    @staticmethod
    def from_script(script: PyBinary) -> ScriptBuilder:
        r"""
    ...
    def add_ops(self, opcodes: typing.Any) -> ScriptBuilder:
        ...
        """
    def add_data(self, data: PyBinary) -> ScriptBuilder:
        r"""
    ...
    def add_sequence(self, sequence: builtins.int) -> ScriptBuilder:
        ...
        """
    @staticmethod
    def canonical_data_size(data: PyBinary) -> builtins.int:
        r"""
    ...
    def create_pay_to_script_hash_script(self) -> ScriptPublicKey:
        ...
        """
    def encode_pay_to_script_hash_signature_script(self, signature: PyBinary) -> builtins.str:
        r"""
...
class ScriptPublicKey:
    ...
    """
    @property
    def script_as_hex(self) -> builtins.str:
        r"""
        ...
        """
    def __new__(cls, version: builtins.int, script: PyBinary) -> ScriptPublicKey:
        r"""
...
class Transaction:
    ...
    """
    @property
    def id_string(self) -> builtins.str:
        r"""
        The transaction ID (hash).
        ...
        """
    @property
    def inputs_as_list(self) -> builtins.list[TransactionInput]:
        r"""
        ...
        """
    @property
    def outputs_as_list(self) -> builtins.list[TransactionOutput]:
        r"""
    ...
    def gas(self, value: builtins.int) -> None:
        ...
        """
    @property
    def subnetwork_id_as_hex(self) -> builtins.str:
        r"""
        ...
        """
    @property
    def payload_as_hex_string(self) -> builtins.str:
        r"""
    ...
    def mass(self, value: builtins.int) -> None:
        ...
        """
    @inputs_from_list.setter
    def inputs_from_list(self, value: builtins.list[TransactionInput]) -> None:
        r"""
        ...
        """
    @outputs_from_list.setter
    def outputs_from_list(self, value: builtins.list[TransactionOutput]) -> None:
        r"""
        ...
        """
    @subnetwork_id_from_value.setter
    def subnetwork_id_from_value(self, value: builtins.str) -> None:
        r"""
        ...
        """
    @payload_from_value.setter
    def payload_from_value(self, value: PyBinary) -> None:
        r"""
    ...
    def finalize(self) -> Hash:
        ...
        """
    def __new__(cls, version: builtins.int, inputs: typing.Sequence[TransactionInput], outputs: typing.Sequence[TransactionOutput], lock_time: builtins.int, subnetwork_id: PyBinary, gas: builtins.int, payload: PyBinary, mass: builtins.int) -> Transaction:
        r"""
...
class TransactionInput:
    ...
    def signature_script_as_hex(self) -> typing.Optional[builtins.str]:
        ...
        """
    @signature_script_as_hex.setter
    def signature_script_as_hex(self, value: PyBinary) -> None:
        r"""
    ...
    def utxo(self) -> typing.Optional[UtxoEntryReference]:
        ...
        """
    def __new__(cls, previous_outpoint: TransactionOutpoint, signature_script: PyBinary, sequence: builtins.int, sig_op_count: builtins.int, utxo: typing.Optional[UtxoEntryReference] = None) -> TransactionInput:
        r"""
...
class TransactionOutpoint:
    ...
    """
    @property
    def transaction_id_as_string(self) -> builtins.str:
        r"""
...
class UtxoEntries:
    ...
    """
    @property
    def items_as_list(self) -> builtins.list[UtxoEntryReference]:
        r"""
        ...
        """
    @items_from_list.setter
    def items_from_list(self, value: builtins.list[UtxoEntryReference]) -> None:
        r"""
...
class XPrv:
    ...
    def xprv(self) -> builtins.str:
        ...
        """
    @property
    def private_key_as_hex_string(self) -> builtins.str:
        r"""
    ...
    def depth(self) -> builtins.int:
        ...
        """
    @property
    def parent_fingerprint_as_hex_string(self) -> builtins.str:
        r"""
    ...
    def child_number(self) -> builtins.int:
        ...
        """
    @property
    def chain_code_as_hex_string(self) -> builtins.str:
        r"""
...
def create_transaction(utxo_entry_source: PyUtxoEntries, outputs: PyOutputs, priority_fee: builtins.int, payload: typing.Optional[PyBinary] = None, sig_op_count: typing.Optional[builtins.int] = None) -> Transaction:
    r"""
...
def create_transactions(network_id: NetworkId, entries: PyUtxoEntries, change_address: Address, outputs: typing.Optional[PyOutputs] = None, payload: typing.Optional[PyBinary] = None, fee_rate: typing.Optional[builtins.float] = None, priority_fee: typing.Optional[builtins.int] = None, priority_entries: typing.Optional[PyUtxoEntries] = None, sig_op_count: typing.Optional[builtins.int] = None, minimum_signatures: typing.Optional[builtins.int] = None) -> dict:
    r"""
...
def estimate_transactions(network_id: NetworkId, entries: PyUtxoEntries, change_address: Address, outputs: typing.Optional[PyOutputs] = None, payload: typing.Optional[PyBinary] = None, fee_rate: typing.Optional[builtins.float] = None, priority_fee: typing.Optional[builtins.int] = None, priority_entries: typing.Optional[PyUtxoEntries] = None, sig_op_count: typing.Optional[builtins.int] = None, minimum_signatures: typing.Optional[builtins.int] = None) -> GeneratorSummary:
    r"""
...
def is_script_pay_to_pubkey(script: PyBinary) -> builtins.bool:
    r"""
...
def is_script_pay_to_pubkey_ecdsa(script: PyBinary) -> builtins.bool:
    r"""
...
def is_script_pay_to_script_hash(script: PyBinary) -> builtins.bool:
    r"""
...
def pay_to_script_hash_script(redeem_script: PyBinary) -> ScriptPublicKey:
    r"""
...
def pay_to_script_hash_signature_script(redeem_script: PyBinary, signature: PyBinary) -> builtins.str:
    r"""
