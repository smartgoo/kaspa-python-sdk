...
impl PyXPub {
    #[new]
    pub fn try_new_py(xpub: &str) -> PyResult<PyXPub> {
        let inner = XPub::from(
    ...
    pub fn derive_child_py(&self, child_number: u32, hardened: Option<bool>) -> PyResult<PyXPub> {
    ...
    pub fn derive_path_py(&self, path: &str) -> PyResult<PyXPub> {
        let path =
    ...
    pub fn public_key_py(&self) -> PyPublicKey {
